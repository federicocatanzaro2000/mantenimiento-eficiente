...
-- Eliminar tabla materiales separada
DROP TABLE IF EXISTS public.materiales CASCADE;

-- Agregar columna JSONB en ordenes
ALTER TABLE public.ordenes ADD COLUMN materiales_utilizados JSONB NOT NULL DEFAULT '[]'::jsonb;

-- Recrear el trigger ampliado para incluir inciso 5
...
REVOKE EXECUTE ON FUNCTION public.ordenes_audit_and_authz() FROM PUBLIC, anon, authenticated;
