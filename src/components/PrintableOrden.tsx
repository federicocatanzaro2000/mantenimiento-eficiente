  ...
  return (
    <div className="print-only po-root">
      ...
      <div className="po-grid po-grid-4">
        ...
        <F label="Prioridad" value={dash(orden.prioridad)} />
      </div>
      ...
      <div className="po-grid po-grid-2">
        <F label="Descripción del problema" value={<div className="po-text">{dash(orden.descripcionProblema)}</div>} />
        <F label="Trabajo solicitado" value={<div className="po-text">{dash(orden.trabajoSolicitado)}</div>} />
      </div>
      ...
      <div className="po-grid po-grid-1">
        <F label="Observaciones" value={<div className="po-text">{dash(orden.observaciones)}</div>} />
      </div>
      ...
      <div className="po-grid po-grid-5">
        ...
        <F label="Elaboró" value={dash(orden.elaboro)} />
        <F label="Revisó" value={dash(orden.reviso)} />
        <F label="Aprobó" value={dash(orden.aprobo)} />
      </div>
