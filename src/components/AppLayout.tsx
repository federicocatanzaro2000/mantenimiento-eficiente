...
import { ClipboardList, FilePlus, Filter, Table2, BarChart3, Users, LogOut, Settings, Wrench, ClipboardCheck } from "lucide-react";
import { cn } from "@/lib/utils";
import logo from "@/assets/logo-incalfood.png";
import { useAuth } from "@/hooks/useAuth";
import { isAdminUsuarios, ROLE_LABELS, canCreateOrden, canManageCatalogos } from "@/lib/permissions";
...
export function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  const tabs = [
    ...
    { to: "/relevamientos", label: "Relevamientos", icon: ClipboardCheck, show: true },
